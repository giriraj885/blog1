...
from street_tour_exception import settings
from street_tour_exception.field_map import FieldMap
...
class FriendlyErrorMessagesMixin(FieldMap):
    ...
    def get_field_error_entry(self, error, field):
        ...
        if key+"_code" in field.error_messages:
            code = field.error_messages[key+"_code"]
